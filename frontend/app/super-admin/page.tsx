...
import {
  type StateAdmin,
  type User,
  DEFAULT_STATE_ADMIN_PERMISSIONS,
} from "@/lib/auth-types";
...
export default function SuperAdminPage() {
  ...
  useEffect(() => {
    const checkAuthAndLoadData = async () => {
      try {
        ...
        const transformedAdmins: StateAdmin[] = adminsRes.stateAdmins.map(
          (admin: any) => ({
        ...
        const transformedUsers: User[] = adminsRes.stateAdmins.map(
          (admin: any) => ({
            id: admin._id || admin.id,
            email: admin.email,
  ...
  const activeStates = Object.values(NIGERIAN_STATES).filter(
    (state) => state.isActive,
  );
  const statesWithAdmins = stateAdmins.map((admin) => admin.stateCode);
  const statesWithoutAdmins = activeStates.filter(
    (state) =>
      !statesWithAdmins.includes(
        Object.keys(NIGERIAN_STATES).find(
          (key) => NIGERIAN_STATES[key] === state,
        ) || "",
      ),
  );
  ...
  const filteredAdmins = stateAdmins.filter((admin) => {
    ...
    const matchesState =
      selectedState === "all" || admin.stateCode === selectedState;
  ...
  const handleCreateAdmin = async () => {
    ...
    try {
      ...
      const newStateAdmin: StateAdmin = {
        ...
        stateCode: response.stateAdmin.stateCode,
        authorityName:
          NIGERIAN_STATES[response.stateAdmin.stateCode]?.wasteAuthority.name ||
          "",
      ...
      if (err instanceof ApiError) {
        ...
        showInlineError("Failed to create state admin");
      }
    ...
    try {
      ...
      setUsers(
        users.map((user) => {
          ...
          return admin && user.id === admin.userId
      ...
      if (err instanceof ApiError) {
        ...
        showInlineError("Failed to toggle admin status");
      }
  ...
  const handleEditAdmin = async () => {
    ...
    try {
      ...
      if (err instanceof ApiError) {
        ...
        showInlineError("Failed to update admin");
      }
  ...
  const handleDeleteAdmin = async () => {
    ...
    try {
      ...
      setStateAdmins(
        stateAdmins.filter((admin) => admin.id !== selectedAdmin.id),
      );
      ...
      if (err instanceof ApiError) {
        ...
        showInlineError("Failed to delete admin");
      }
  ...
  const calculateTotalRevenue = () => {
    ...
    return stateRevenueData.reduce(
      (sum, state) => sum + state.monthlyRevenue,
      0,
    );
  };
  ...
  const calculateAverageCollectionRate = () => {
    ...
    if (
      platformStats?.totalBills > 0 &&
      platformStats?.paidBills !== undefined
    ) {
      return Math.round(
        (platformStats.paidBills / platformStats.totalBills) * 100,
      );
    }
    // Otherwise calculate from stateRevenueData
    if (stateRevenueData.length === 0) return 0;
    const total = stateRevenueData.reduce(
      (sum, state) => sum + state.collectionRate,
      0,
    );
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Manage state administrators across Nigeria
                    </p>
                  </div>
                </div>
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            ...
                            <p className="text-xs text-gray-500">
                              ₦
                              {(platformStats.monthlyRevenue / 1000000).toFixed(
                                1,
                              )}
                              M this month
                            </p>
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            ...
                            <p className="text-2xl font-bold text-gray-900">
                              {platformStats.activeStates}
                            </p>
                            <p className="text-xs text-gray-500">
                              of {platformStats.totalStates} total
                            </p>
                          </div>
                        </div>
                      </CardContent>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {
                              stateAdmins.filter((admin) => admin.isActive)
                                .length
                            }
                          </p>
                        </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {statesWithAdmins.length}
                          </p>
                          <p className="text-xs text-gray-500">
                            of {activeStates.length} active
                          </p>
                        </div>
                      </div>
                    </CardContent>
                      ...
                      {stateAdmins.slice(0, 5).map((admin) => {
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center space-x-3">
                              <div
                                className={`w-2 h-2 rounded-full ${admin.isActive ? "bg-green-500" : "bg-red-500"}`}
                              />
                              <div>
              ...
              <TabsContent value="admins" className="mt-6">
                <div className="flex flex-col md:flex-row gap-4 mb-6">
                  ...
                  >
                    ...
                    <DialogContent className="max-w-2xl">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Create a new administrator account for a state waste
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="col-span-2">
                          ...
                          <Select
                            ...
                            onValueChange={(value) =>
                              setNewAdmin({ ...newAdmin, stateCode: value })
                            }
                          >
                            <SelectTrigger>
                                ...
                                <div className="flex items-center space-x-1">
                                  <Switch
                                    ...
                                    onCheckedChange={(checked) => {
                                      ...
                                      updatedPermissions[index].canView =
                                        checked;
                                      setNewAdmin({
                                        ...newAdmin,
                                ...
                                <div className="flex items-center space-x-1">
                                  <Switch
                                    ...
                                    onCheckedChange={(checked) => {
                                      ...
                                      updatedPermissions[index].canCreate =
                                        checked;
                                      setNewAdmin({
                                        ...newAdmin,
                                        permissions: updatedPermissions,
                                ...
                                <div className="flex items-center space-x-1">
                                  <Switch
                                    ...
                                    onCheckedChange={(checked) => {
                                      ...
                                      updatedPermissions[index].canUpdate =
                                        checked;
                                      setNewAdmin({
                                        ...newAdmin,
                                        permissions: updatedPermissions,
                  ...
                  <Dialog
                    ...
                    onOpenChange={setIsViewAdminOpen}
                  >
                    <DialogContent className="max-w-2xl">
                      <DialogHeader>
                        <DialogTitle>Administrator Details</DialogTitle>
                        <DialogDescription>
                          View state administrator information
                        </DialogDescription>
                      </DialogHeader>
                      {selectedAdmin &&
                        (() => {
                          const user = users.find(
                            (u) => u.id === selectedAdmin.userId,
                          );
                      ...
                      <DialogFooter>
                        <Button
                          variant="outline"
                          onClick={() => setIsViewAdminOpen(false)}
                        >
                          Close
                        </Button>
                      </DialogFooter>
                  ...
                  >
                    <DialogContent className="max-w-2xl">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Update state administrator information
                        </DialogDescription>
                      </DialogHeader>
                      {selectedAdmin &&
                        (() => {
                        ...
                        (() => {
                          ...
                          return (
                            <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                              ...
                              <p className="text-sm text-gray-600">
                                {state?.name} - {selectedAdmin.authorityName}
                              </p>
                            </div>
                          );
                        })()}
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Manage administrator accounts for all state waste
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {calculateAverageCollectionRate()}%
                          </p>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {calculateTotalBills().toLocaleString()}
                          </p>
                          <p className="text-xs text-gray-500 mt-1">
                            {calculateTotalPaidBills().toLocaleString()} paid
                          </p>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <CardDescription>
                          Detailed financial breakdown for each state
                        </CardDescription>
                      </div>
                      <div className="flex items-center space-x-3">
                        <Select
                        ...
                        {stateRevenueData
                          .filter((state) => {
                            if (revenueFilter === "high")
                              return state.collectionRate > 85;
                            if (revenueFilter === "medium")
                              return (
                                state.collectionRate >= 70 &&
                                state.collectionRate <= 85
                              );
                            if (revenueFilter === "low")
                              return state.collectionRate < 70;
                            return true;
                          })
                          ...
                          .map((state) => (
                            <TableRow key={state.stateCode}>
                              ...
                              <TableCell>
                                <div>
                                  <p className="font-semibold text-green-600">
                                    {formatCurrency(state.monthlyRevenue)}
                                  </p>
                                  <p className="text-xs text-gray-500">
                                    ₦
                                    {(state.monthlyRevenue / 1000000).toFixed(
                                      1,
                                    )}
                                    M
                                  </p>
                              ...
                              <TableCell>
                                <div>
                                  <p className="font-medium">
                                    {state.totalBills.toLocaleString()}
                                  </p>
                                  <p className="text-xs text-gray-500">
                                    {state.pendingBills} pending,{" "}
                                    {state.overdueBills} overdue
                                  </p>
                                </div>
                              </TableCell>
                              <TableCell>
                                <div>
                                  <p className="font-medium text-blue-600">
                                    {state.paidBills.toLocaleString()}
                                  </p>
                                  <p className="text-xs text-gray-500">
                                    {Math.round(
                                      (state.paidBills / state.totalBills) *
                                        100,
                                    )}
                                    % of total
                                  </p>
                              ...
                              <TableCell>
                                <div>
                                  <p className="font-medium">
                                    {state.totalUsers.toLocaleString()}
                                  </p>
                                  <p className="text-xs text-gray-500">
                                    {state.activeUsers.toLocaleString()} active
                                  </p>
                                </div>
                              </TableCell>
                              <TableCell>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {stateRevenueData
                          ...
                          .map((state) => {
                            const percentage =
                              (state.monthlyRevenue / calculateTotalRevenue()) *
                              100;
                            return (
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Collection rates across states
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        {statesWithoutAdmins.map((state) => {
                          const stateKey = Object.keys(NIGERIAN_STATES).find(
                            (key) => NIGERIAN_STATES[key] === state,
                          );
                          return (
                            <div
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-bold text-blue-600">
                            {Math.round(
                              (statesWithAdmins.length / activeStates.length) *
                                100,
                            )}
                            %
                          </span>
