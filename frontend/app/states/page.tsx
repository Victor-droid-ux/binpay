...
const STATE_MAPS: Record<string, { embedUrl: string; description: string }> = {
  lagos: {
    embedUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d253682.62697814634!2d3.1191679!3d6.5243793!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b8b2ae68280c1%3A0xdc9e87a367c3d9cb!2sLagos!5e0!3m2!1sen!2sng!4v1694123456789!5m2!1sen!2sng",
    description:
      "Comprehensive waste management coverage across all 20 Local Government Areas in Lagos State. LAWMA operates in 5 major zones covering Lagos Island, Lagos Mainland, Surulere, Ikeja, and Ikorodu regions.",
  },
  fct: {
    embedUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d252230.02926364106!2d7.3986474!3d9.0764785!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104e0baf7da48d0d%3A0x99a8fe4168c50bc8!2sAbuja!5e0!3m2!1sen!2sng!4v1694123456789!5m2!1sen!2sng",
    description:
      "Full environmental protection services across all 6 Area Councils in the Federal Capital Territory. AEPB maintains service zones in Abuja Municipal, Gwagwalada, Kuje, Bwari, Kwali, and Abaji.",
  },
  enugu: {
    embedUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d507394.77441234!2d6.7227018!3d6.5126673!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x105b662586cf0979%3A0x27595621a4034717!2sEnugu!5e0!3m2!1sen!2sng!4v1694123456789!5m2!1sen!2sng",
    description:
      "Complete waste management services across all 17 Local Government Areas in Enugu State. ESWAMA operates in 5 strategic zones covering Enugu, Nsukka, Oji River, Awgu, and Udi regions.",
  },
};
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-4 text-sm text-gray-600">
            <p>
              <strong>Coverage Area:</strong> All {selectedState.lgas.length}{" "}
              Local Government Areas
            </p>
            <p>
              <strong>Service Zones:</strong>{" "}
              {selectedState.wasteAuthority.zones.join(", ")}
            </p>
            <p>
              <strong>Authority:</strong>{" "}
              {selectedState.wasteAuthority.fullName}
            </p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden md:block">
                ...
                <p className="text-sm text-gray-600">
                  Waste management across Nigeria
                </p>
              </div>
            </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {useBackendData
                          ? backendStates.filter((s) => s.isActive).length
                          : activeStates.length}
                      </p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {useBackendData
                          ? backendStates.reduce(
                              (sum, s) =>
                                sum + (s._count?.lgas || s.lgas.length),
                              0,
                            )
                          : Object.values(NIGERIAN_STATES).reduce(
                              (sum, s) => sum + s.lgas.length,
                              0,
                            )}
                      </p>
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {useBackendData && backendStates.length > 0
                          ? formatCurrency(
                              backendStates.reduce(
                                (sum, s) => sum + s.averageBill,
                                0,
                              ) / backendStates.length,
                            )
                          : formatCurrency(
                              Object.values(NIGERIAN_STATES).reduce(
                                (sum, s) => sum + s.wasteAuthority.averageBill,
                                0,
                              ) / Object.keys(NIGERIAN_STATES).length,
                            )}
                      </p>
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          ...
                          <div className="flex flex-wrap gap-1 mt-2">
                            {state.wasteAuthority.paymentMethods
                              .slice(0, 3)
                              .map((method) => (
                                <Badge
                                  key={method}
                        ...
                        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div>
                            <div className="flex flex-wrap gap-1">
                              {state.wasteAuthority.paymentMethods.map(
                                (method) => (
                                  <Badge
                                    key={method}
                                    variant="outline"
                      ...
                      <div className="space-y-6">
                          ...
                          <CardContent className="space-y-4">
                            <div>
                              <h4 className="font-semibold text-lg">
                                {selectedState.wasteAuthority.name}
                              </h4>
                            ...
                            <div className="space-y-3">
                              <div className="flex items-center space-x-2">
                                ...
                                <span className="text-sm">
                                  {selectedState.wasteAuthority.headquarters}
                                </span>
                              </div>
                          ...
                          <CardContent className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                ...
                                <p className="text-xl font-bold text-green-600">
                                  {formatCurrency(
                                    selectedState.wasteAuthority.averageBill,
                                  )}
                                </p>
                              </div>
                              <div>
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2">
                                {selectedState.wasteAuthority.paymentMethods.map(
                                  (method) => (
                                    <Button
                                      key={method}
                                      variant="outline"
                                    ...
                                    >
                                      <Link
                                        href={`/login?redirect=/dashboard&paymentMethod=${method}`}
                                      >
                            ...
                            <div>
                              ...
                              <div className="grid grid-cols-1 gap-1">
                                {selectedState.wasteAuthority.zones.map(
                                  (zone) => (
                                    <Badge
                                      key={zone}
                                      variant="secondary"
                        ...
                        {selectedState.isActive && (
                          <Button className="w-full" asChild>
                            <Link
                              href={`/register?state=${selectedState.code.toLowerCase()}`}
                            >
              ...
              <Card className="bg-gradient-to-r from-green-50 to-blue-50 border-0">
                <CardContent className="p-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">
                    Ready to Start Paying Your Waste Bills?
                  </h2>
                  <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                    Join thousands of Nigerians who trust Bin-Pay for
                    convenient, secure waste bill payments across all supported
