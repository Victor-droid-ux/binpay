...
export default function AdminLoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.user.role !== "STATE_ADMIN") {
        showInlineError("Access denied. State admin privileges required.");
        authApi.logout();
        setIsLoading(false);
        return;
      }
      ...
      if (
        formData.stateCode &&
        response.user.stateCode !== formData.stateCode
      ) {
        showInlineError(
          `You are not authorized for ${NIGERIAN_STATES[formData.stateCode]?.name}. You manage ${NIGERIAN_STATES[response.user.stateCode]?.name}.`,
        );
        authApi.logout();
        setIsLoading(false);
        return;
  ...
  const activeStates = Object.entries(NIGERIAN_STATES).filter(
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Access your state waste management dashboard
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Sign in to manage waste bills and payments for your state
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) => handleInputChange("stateCode", value)}
              >
                <SelectTrigger>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                This is a secure administrator portal. All activities are logged
                and monitored. Only authorized personnel should access this
                system.
              </p>
            </div>
          </div>
